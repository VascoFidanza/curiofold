...
| TM-06 | Concurrent unlocks, retries or direct mutation overspend credits                 | Grants and unlocks use wallet row locks, globally unique operation keys, atomic entitlement/debit/FIFO allocation, immutable records, deterministic versions and classified reconciliation | Schedule reconciliation and connect its failure signal to alert routing in the operations milestone / Engineering                    | Baseline active         |
