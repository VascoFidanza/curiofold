...
| TM-06 | Concurrent unlocks, retries or direct mutation overspend credits                 | Grants and unlocks use wallet row locks, globally unique operation keys, atomic entitlement/debit/FIFO allocation, immutable financial records and PostgreSQL 18 concurrency tests | CRFD-22 adds continuous reconciliation and customer-safe discrepancy evidence / Engineering                                          | Baseline active         |
