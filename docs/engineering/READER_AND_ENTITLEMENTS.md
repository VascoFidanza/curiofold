...
Text-size and reading-width preferences are local, non-sensitive browser preferences. Storage denial does not interrupt reading. Progress, resume and completion are deliberately deferred to CRFD-16 so this boundary does not invent a second progress model.
